...
def build(out: Path) -> Path:
    ...
    (out / "trace" / "notes.md").write_text(
        "Synthetic process notes. The stage-3 break is the one to watch: an audit at stage 4 found a hole in the metrics plan, which is exactly the upstream-of-the-pass-read line the viewer is built to show.\n",
        encoding="utf-8",
    )
    return out
