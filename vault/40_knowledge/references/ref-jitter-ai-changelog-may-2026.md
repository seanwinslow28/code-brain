---
title: "What’s new in Jitter – Updates and improvements"
source: "https://jitter.video/changelog/?utm_source=broadcast&utm_medium=email&utm_campaign=may-2026"
author:
published:
created: 2026-05-13
...
[My files](https://jitter.video/files/)

## Jitter AI

Today we're launching Jitter AI: an unlimited set of creative tools you can build yourself with just a prompt.

Most design tools give you a fixed set of capabilities you have to work within. Jitter AI flips that. Simply describe the creative tool you need (such as a fluted glass background, a ripple effect, a glitch transition, a 3D rotation, or a card flip), and Jitter will build it for you, right inside the interface you already know.

The tools you build aren't one-offs. You can refine them, reuse them across layers and files, and share with your team so everyone can produce on-brand animated assets in minutes.

Here's how it works.

1. Select the layer or group you'd like to animate on the canvas.
2. In the right-hand sidebar, switch to the *Animate* tab.
3. Click *Animate with AI* and type what you'd like to happen (e.g., "add a dithering effect" or "create an animation with a pixelated effect").

In a few seconds, Jitter will generate the custom effect for you. From there, you can tweak the result by refining your prompt, and adjust the animation parameters manually if you like.

With Jitter AI, we're also launching a [set of brand new templates](https://jitter.video/templates/jitter-ai/) created with its help for you to explore, get inspired by, and remix.

## Other improvements

- Artboard to PNG: You can now download your artboards as PNGs by right-clicking them and selecting *Copy as...*.

<video src="https://assets.jitter.video/batch-export.mp4" controls=""></video>

[May 5, 2026](https://jitter.video/changelog/2026-05-06-batch-export/)

## Batch export

If you're working with multiple artboards (design variations, different sizes, or several languages), exporting just became a lot faster. You can now select the artboards you need and export them all at once in a click.

Here's how to use batch export:

1. In your Jitter file, select the artboards you'd like to export.
2. Click the *Export* button in the top right corner.
3. Choose your export format.
4. You'll land on the export page with all of your selected files exported. From here, you can further adjust the export settings, choose to download some of the scenes individually, or simply hit the *Download* button to save them all to your device.

Batch export is available on the Jitter Max plan.

## Other improvements

- Smoother Figma import: Figma imports now carry over line cap and join styles exactly as designed.
- Bug fix: Fixed an issue where files with long text layers could be slow to open.

<video src="https://assets.jitter.video/displacement-shaders.mp4" controls=""></video>

[Apr 19, 2026](https://jitter.video/changelog/2026-04-20-displacement-shaders/)

## Displacement shaders

You can now add organic, wave-like distortion to your elements in Jitter. Displacement shaders let you create animation distortion effects using amplitude, offset, and repeat controls for both the initial state and the animated state. It's a powerful way to create fluid motion, organic transitions, reveal animations, and ambient backgrounds.

Here's how to use the new feature:

1. Select the element you'd like to animate on the canvas.
2. In the right-hand sidebar, switch to the *Animate* tab.
3. Click *Add animation* and choose *Displacement*.
4. Set the *Initial value* by tweaking *Amplitude*, *Offset*, and *Repeat* to define where the distortion starts.
5. Below that, set your target values for the same controls — this is where the distortion will end up after the animation plays.
6. Set the *Direction* to *Horizontal*, *Vertical*, or *Both*.
7. Adjust *Duration* and *Easing* to control how the transition feels.

<video src="https://assets.jitter.video/independent-corner-radius.mp4" controls=""></video>

[Apr 8, 2026](https://jitter.video/changelog/2026-04-09-independent-corner-radius/)

## Independent corner radius

You can now adjust each corner radius of a shape separately in Jitter: great for designing playful buttons, cards, speech bubbles, and other elements that aren’t meant to be perfectly symmetrical.

Here’s how to use independent corner radius:

1. Select a shape on the canvas.
2. In the right-hand sidebar, make sure you're in the *Design* tab and find the *Corner* section.
3. Click on the corner radius icon to switch from a linked radius to independent corner editing.
4. Add the radius value for each corner.

That's it! It’s an easy way to make shapes feel more custom without having to recreate them as vectors.

## Other improvements

- Bug fix: Fixed an issue where adding an *In* preset to an object after an *Out* preset could cause it to disappear.

<video src="https://assets.jitter.video/pen-tool.mp4" controls=""></video>

[Mar 31, 2026](https://jitter.video/changelog/2026-04-01-improved-pen-tool-for-advanced-shapes/)
...
<video src="https://assets.jitter.video/custom-text-effects.mp4" controls=""></video>

[Mar 17, 2026](https://jitter.video/changelog/2026-03-18-custom-text-effects/)
...
<video src="https://assets.jitter.video/multi-layer-hide-lock.mp4" controls=""></video>

[Mar 10, 2026](https://jitter.video/changelog/2026-03-11-multi-layer-hide-lock/)

## Multi-layer hide and lock

Managing Jitter files with many layers just got a little smoother. You can now quickly hide (or show) and lock (or unlock) multiple layers in one sweep.

Here's how it works:

1. In the layer list (the left-hand panel in your Jitter file), click and hold the hide or lock icon next to any layer.
2. Drag down across other layers.
3. Release to hide/show or lock/unlock all selected layers in one go.

<video src="https://assets.jitter.video/image-to-video-prompting.mp4" controls=""></video>

[Mar 2, 2026](https://jitter.video/changelog/2026-03-03-image-to-video-prompting/)

## Prompting: Image to video

Prompting is now part of Image to Video in Jitter! You can now tweak the auto-generated prompt or replace it completely to get exactly the video you want.

Here's how you can write your own Image to Video prompt:

1. Open your Jitter file and select the image you'd like to generate a video from.
2. In the sidebar on the right, go to the *Animate* tab.
3. Click *View and edit prompt*.
4. Edit the generated prompt (or write your own) and click *Generate video*.

<video src="https://assets.jitter.video/figma-draw.mp4" controls=""></video>

[Feb 24, 2026](https://jitter.video/changelog/2026-02-25-figma-draw-plugin/)

## Figma Draw plugin

Today we're launching Jitter for Figma Draw! You can now import your Figma Draw designs into Jitter in a click and start animating them right away. Everything will be imported pixel-perfect, including:

- Variable strokes
- Brushes
- Patterns

Here's how you can get started with Jitter for Figma Draw:

1. [Install Jitter's Figma plugin](https://www.figma.com/community/plugin/961270034818256057/jitter-animation-for-figma) if you don't have it yet.
2. In Figma Draw, select the frame(s) you'd like to export and click the *Copy* button on the plugin.
3. Click *Open in Jitter* on the plugin to import your design.
4. Animate! ✨

<video src="https://assets.jitter.video/20260217-blend-modes.mp4" controls=""></video>

[Feb 16, 2026](https://jitter.video/changelog/2026-02-17-blend-modes-templates/)

## Template collection: Blend modes

Today's template drop is built around blend modes: from bold overlays to subtle texture, light leaks, and color shifts, this template set makes it easy to get richer visuals fast. [Explore the new collection here](https://jitter.video/templates/blend-modes/).

<video src="https://assets.jitter.video/image-to-video_16.9.mp4" controls=""></video>

[Feb 9, 2026](https://jitter.video/changelog/2026-02-10-image-to-video/)
...
1. Open your Jitter file and select the image you'd like to generate a video from.
2. In the sidebar on the right, go to the *Animate* tab and click *Generate video*.
...
<video src="https://assets.jitter.video/the-click_16.9.mp4" controls=""></video>

[Jan 27, 2026](https://jitter.video/changelog/2026-01-28-the-click/)

## Template collection: The Click

Today’s template drop is all about buttons, toggles, menus, and delightful micro-interactions. From subtle glows to liquid glass effects to cursor-traced hovers, these are perfect for sparking interaction and engagement across social media, ads, and interfaces. [Explore the new templates here](https://jitter.video/templates/the-click/).

## Other improvements

- Brainstorm fix: Fixed an issue where AI Brainstorm would not launch on some canvases.
- Unsaved changes warning: Added a warning message if you try to leave the editor with unsaved local changes.
- Instagram preset update: Updated the Instagram post size preset from 1:1 to 4:5.

<video src="https://assets.jitter.video/formulas-in-input-fields.mp4" controls=""></video>

[Jan 20, 2026](https://jitter.video/changelog/2026-01-21-formulas-in-input-fields/)

## Formulas in input fields
...
<video src="https://assets.jitter.video/gradient-templates.mp4" controls=""></video>

[Dec 29, 2025](https://jitter.video/changelog/2025-12-30-gradient-templates/)

## Template collection: Gradients

Today we're shipping a set of templates built around gradients. From ambient backgrounds to dynamic transitions and playful type, these are perfect for adding dimension and character to your designs. [Explore the new templates here](https://jitter.video/templates/gradients/).

## Other improvements

- Smoother collaboration: Live collaboration is more stable, with easier recovery if your connection drops.
- Easier text SVG updates: We fixed an issue where updating the font in text SVG (text imported from Figma as SVG due to a missing font) could change text size, and made conversions from text SVGs to editable text layers more robust.
- Improved export stability: Exports are now more reliable, with fewer failures and better handling if something doesn’t work on the first try.

<video src="https://assets.jitter.video/the-route-travel-templates.mp4" controls=""></video>

[Dec 1, 2025](https://jitter.video/changelog/2025-12-02-the-route-travel-templates/)

## Template collection: The Route

Meet *The Route*: a set of 9 templates designed for modern travel brands. From destination promos and logo reveals to virtual boarding passes and animated flight trackers, these templates are a great starting point for bringing travel stories to life. Use them for destination marketing, ad campaigns, and elevated brand storytelling. [Explore the new templates here](https://jitter.video/templates/the-route/).

## Other improvements

- Better operation resizing: Pressing ⌥ (Mac) or Alt (Windows) now resizes timeline operations symmetrically.
- Smoother focusing: Double-clicking a layer's icon in the layer list now brings the focus to the layer with a smoother transition.
- Loop by default: Timeline playback now loops automatically.
- New shortcut: Pressing M now toggles between *Design* and *Animate* modes.
- Handy shortcuts: Keyboard shortcuts now appear in toolbar tooltips.
- Improved file loading: Files now open without flashing an empty frame.
- Drag & drop fix: Dragging a layer now accurately matches mouse movement.
- Team invite fix: Fixed an issue where some team invites incorrectly showing as “not found”.

<video src="https://assets.jitter.video/ai-brainstorm.mp4" controls=""></video>

[Nov 24, 2025](https://jitter.video/changelog/2025-11-25-ai-brainstorm/)
...
1. Open your Jitter file and click the ✨ icon in the top right corner of your artboard to open the AI menu.
2. Pick a mood (playful, bold, soft, elegant, or cinematic) to generate a draft.
...
<video src="https://assets.jitter.video/blend-modes.mp4" controls=""></video>

[Nov 3, 2025](https://jitter.video/changelog/2025-11-04-blend-modes/)
...
- Design playful type animations where the text interacts with the background
- Add natural glows, highlights, and shadows
- Bring in grain, texture, or noise to give your designs a tactile feel
- Recolor images and videos without losing detail
- Create translucent, glass-like effects

Here’s how to get started with blend modes:

1. Select any layer on the canvas.
2. In the right sidebar, make sure you're in the *Design* tab and scroll to the *Opacity* section.
3. Click on the drop icon and choose an option (e.g. *Multiply*, *Screen*, *Overlay*).
4. Experiment with different modes to see how your layer interacts with the ones beneath it.

<video src="https://assets.jitter.video/the-prompt-ai-templates.mp4" controls=""></video>

[Oct 27, 2025](https://jitter.video/changelog/2025-10-28-the-prompt-ai-templates/)

## Template collection: The Prompt

Today we’re launching *The Prompt*, a set of 6 templates built for AI companies. From chat interfaces and animated buttons to generation flows, these templates are made to bring your AI features to life. Use them to showcase new capabilities, run product ads, or illustrate real AI workflows, from chat replies to image outputs. [Explore the new templates here](https://jitter.video/templates/the-prompt/).

## Other improvements

- Improved resource accessibility: Jitter files now load more reliably for users on corporate networks or VPNs.
- Smoother artboard zoom: Camera movement is now smoother when focusing on an artboard, making navigation feel more natural.

<video src="https://assets.jitter.video/figma-buzz-plugin.mp4" controls=""></video>

[Oct 22, 2025](https://jitter.video/changelog/2025-10-23-figma-buzz-plugin/)
...
1. [Install Jitter's Figma plugin](https://www.figma.com/community/plugin/961270034818256057/jitter-animation-for-figma) if you don't have it yet.
2. In Figma Buzz, select the frame(s) or you'd like to export and click the *Copy* button on the plugin.
3. Click *Open in Jitter* in the plugin to import your design.
4. Animate! ✨

<video src="https://assets.jitter.video/sport-and-fitness-templates.mp4" controls=""></video>

[Oct 6, 2025](https://jitter.video/changelog/2025-10-07-sport-and-fitness-templates/)

## Template collection: The Track
...
Use these templates to announce new launches, celebrate milestones with your customers, or run ad campaigns with motion that's bold, high-tempo, and built to stop the scroll. [Try the new templates here](https://jitter.video/templates/new/).

<video src="https://assets.jitter.video/gradients-on-strokes.mp4" controls=""></video>

[Sep 29, 2025](https://jitter.video/changelog/2025-09-30-gradients-on-strokes/)
...
2. In the *Design* tab, check the box next to *Stroke* and adjust its weight.
3. Click the stroke color, then switch to the *Linear* or *Radial* tab to apply a gradient.
4. To animate the gradient, go to the *Animate* tab, click *Custom*, and select *Stroke*.
5. Adjust gradient type and color stops until you get the perfect look.

## Other improvements

- Bug fix: Fixed an issue on mobile where the player wouldn’t be shown.
- Downloadable assets: You can now download your original media from Jitter by clicking on the *...* next to the *Replace media* button.
- More reliable collaboration: All workspace files have been migrated to a faster, more reliable system for better sync and performance.
- Stroke gradient import: You can now import gradient strokes from Figma seamlessly using the plugin.

<video src="https://assets.jitter.video/tech-templates.mp4" controls=""></video>

[Sep 8, 2025](https://jitter.video/changelog/2025-09-09-tech-templates/)

## Template collection: The Stack

Meet *The Stack* — our new collection of 6 templates designed for tech companies and startups. Whether you’re working on a video for a feature launch, a social media reel, or a company announcement, The Stack gives you a strong starting point that feels modern, polished, and scalable. [Explore The Stack](https://jitter.video/templates/new/).

## Other improvements

- Improved undo/redo: We've fixed several undo/redo issues in text editing (with full and partial selection).
- Smoother rendering: Rendering is now smoother and more reliable, especially in zoomed-out views and with hidden elements.

<video src="https://assets.jitter.video/pen-tool-templates.mp4" controls=""></video>

[Aug 25, 2025](https://jitter.video/changelog/2025-08-26-pen-tool-templates/)

## Pen tool & morph templates

We just dropped a new batch of templates that make the most of our recent product update: pen tool and morphing. From fluid icon animations to seamless shape and text morphs, use these templates to create motion that’s flexible, dynamic, and uniquely yours. [Try them out here](https://jitter.video/templates/new/).

## Other improvements

- Bug fix: Fixed a crash that could occur when resizing instant (zero-duration) operations.
- Bug fix: Fixed a crash caused by negative audio or video duration in the timeline.
- Bug fix: Fixed an issue where shapes could lose their opacity when modified with the pen tool.

<video src="https://assets.jitter.video/faster-export.mp4" controls=""></video>

[Aug 18, 2025](https://jitter.video/changelog/2025-08-19-faster-export/)
...
- Bug fix: We've fixed an issue that could cause export to fail for anonymous users. Exports now work seamlessly even if you’re not signed in.

<video src="https://assets.jitter.video/text-gradients.mp4" controls=""></video>

[Aug 12, 2025](https://jitter.video/changelog/2025-08-13-text-gradients/)
...
1. Select a text layer on the canvas.
2. To fill a text with a gradient, make sure you're in the *Design* tab and click on the color in the *Fill* section.
3. In the *Linear* or *Radial* tab, set up the gradient for your text.
4. To create a gradient animation, switch to the *Animate* tab and click *New animation* -> *Custom* -> *Color*.
5. Choose between linear and radial gradients and adjust color stops to create your perfect blend.

## Other improvements

- Bug fix: Fixed an issue where the selection box sometimes wouldn’t appear during rectangle selection.
- Bug fix: Fixed a server export bug that could cause exporting files with special characters in their names to fail.
- Bug fix: Improved comment input so words no longer break awkwardly in the middle — we now keep them intact whenever possible.

<video src="https://assets.jitter.video/reel_16-9.mp4" controls=""></video>

[Aug 4, 2025](https://jitter.video/changelog/2025-08-05-fintech-templates/)

## Template collection: The Vault

Meet *The Vault* — our new collection of 9 templates made for fintech and banking companies, perfect for product updates, demos, feature highlights, and more. Whether you’re working on a social media reel, an ad, or a website animation, The Vault gives you a great starting point that feels sharp, credible, and clean. [Explore The Vault](https://jitter.video/templates/new/).

## Other improvements

- Bug fix: Fixed an issue where media files with special characters in their names could fail to import.

<video src="https://assets.jitter.video/new-google-fonts.mp4" controls=""></video>

[Jul 15, 2025](https://jitter.video/changelog/2025-07-16-new-google-fonts/)
...
- Freeze last frame: You can now choose to hold the final frame of a video layer using the *Freeze last frame* option in the right-hand sidebar.
- Bug fix: Fixed an issue where text layers could disappear when changing fonts.

<video src="https://assets.jitter.video/pen-tool-and-morphing.mp4" controls=""></video>

[Jul 7, 2025](https://jitter.video/changelog/2025-07-08-pen-tool-and-morphing/)

## Pen tool and morphing
...
- Design custom product animations, like looping loaders with fluid shape transitions
- Animate a logo from a simple shape into the full mark — or morph it into a new identity for a launch or rebrand
- Create playful text animations where letters transform seamlessly into shapes (or vice versa)
- Smoothly transition UI elements between states, like buttons expanding into cards, or icons adapting as menus open

Here's how to get started with the new features:

1. Select the pen tool in the top toolbar.
2. Click on the canvas to create your first point, then click again to create another one and connect the two points with a straight line. Drag to reposition points, or drag and hold ⌘ (Ctrl on Windows) to turn lines into curves.
3. Select your shape and go to the *Animate* tab.
4. Click *New animation*, open the *Custom* tab, and choose *Morph*.
5. Edit the shape to create its final form — this updated shape will become the *To* value of your morph animation.

## Other improvements

- Faster-loading assets: Assets in image-heavy files now load much faster.
- Highlight on hover: Hovering over a shape now highlights its outline, so you can easily see which layer you're about to select.
- Bug fix: We've fixed a bug where scrolling the layer list would ocassionally scroll the canvas instead.

<video src="https://assets.jitter.video/20250617-the-edit-templates.mp4" controls=""></video>

[Jun 16, 2025](https://jitter.video/changelog/2025-06-17-template-collection-the-edit/)

## Template collection: The Edit

Today, we're launching *The Edit* — a collection of 12 templates created for fashion and beauty brands. Whether you're launching a new collection, showcasing products, or running cross-platform ads, these templates will help you brings sleek, elevated motion to every post. [Try them out here](https://jitter.video/templates/new/).

## Other improvements

- Transparent video fix: We've fixed a bug that could lead to some animations with a transparent background to be exported without the transparency.
- Better real-time collaboration: Workspace files with multiple editors in them now load more reliably.

<video src="https://assets.jitter.video/20250603-blur-templates.mp4" controls=""></video>

[Jun 2, 2025](https://jitter.video/changelog/2025-06-03-blur-templates/)

## Blur templates

We just dropped a new batch of templates that make the most of blur, one of our most requested creative features we recently shipped. From dreamy transitions to smooth text reveals, use these templates to add depth, focus, and polish to your animations. [Try them out here](https://jitter.video/templates/new/).

## Other improvements

- Smoother teamwork: Real-time collaboration just got more reliable, with improved syncing and stability across shared files.
- Anonymous export fix: We've fixed an issue that could prevent users without a Jitter account from exporting files.

<video src="https://assets.jitter.video/bezier-controls-curved-paths.mp4" controls=""></video>

[May 26, 2025](https://jitter.video/changelog/2025-05-27-bezier-controls-for-curved-paths/)

## Bezier controls for curved paths
...
1. Select a layer you'd like to animate, switch to the *Animate* tab, click *New animation*, and select *Custom -> Move*.
2. Check the *Bezier controls* box.
3. Drag the handles to sculpt the curve exactly how you want it!
...
- Improved audio placement: Audio tracks will now be added at the current point on the timeline, and not at the beginning of your animation.
- Bug fix: We've fixed a bug where the timeline could disappear after duplicating a template.

<video src="https://assets.jitter.video/config-2025.mp4" controls=""></video>

[May 4, 2025](https://jitter.video/changelog/2025-05-05-figma-config/)

## Figma Config 2025

As an official [Figma Config 2025](https://config.figma.com/) sponsor, we're proud to announce a batch of exclusive Config templates we created for attendees to showcase their time at the event.
...
👉 [Remix them now](https://jitter.video/community/config/)

<video src="https://assets.jitter.video/new-website-2025.mp4" controls=""></video>

[Apr 7, 2025](https://jitter.video/changelog/2025-04-08-new-website/)

## New website

We just launched the new [Jitter website](https://jitter.video/?noredir=1) — a fresh look that reflects how far we’ve come and where we’re headed next. This launch marks a new chapter for our brand: a more confident voice, a stronger visual identity, and creativity front and center. This is Jitter, leveled up.

## Other improvements

- Faster Figma import: We've added caching to our Figma plugin, your designs will now import faster from Figma to Jitter.
- Better file names: Files created via Figma import will now be named after your Figma files.
- Bug fix: We've fixed a bug that would occasionally cause assets to disappear in the edit.
- Fix a bug where video would not show in the effect gallery

<video src="https://assets.jitter.video/easing-css.mp4" controls=""></video>

[Mar 17, 2025](https://jitter.video/changelog/2025-03-18-css-easing-export/)
...
1. Select a layer that's being animated and switch to the *Animate* tab.
2. Under *Animation*, click on the *Settings* icon next to *Easing*.
3. Click on *...* in the top right corner and select *Copy as CSS*.

## Other improvements

- More control over curved paths: You can now use precise Bezier controls to edit the path for the *Move* action.
- New keyboard shortcut: Jump to a group's child in the timeline by hitting Enter, or go to the element's parent with Shift ⇧ + Enter.
- Improvement: New artboards are now added at the top of the layer list, like other layers.
- Bug fix: We've fixed an issue that could prevent files imported from Figma from being exported correctly.
- Bug fix: Unstable network connections no longer cause the editor to crash.

<video src="https://assets.jitter.video/20250226-figma-plugin.mp4" controls=""></video>

[Feb 25, 2025](https://jitter.video/changelog/2025-02-26-all-new-figma-plugin/)

## All-new Figma plugin

We’ve rebuilt our [Figma plugin](https://www.figma.com/community/plugin/961270034818256057/jitter-animation-for-figma) from the ground up for pixel-perfect compatibility, better performance, and powerful new import features:

- **Figma Slides support**: Import your Figma Slides decks into Jitter in just one click, just like you would in Figma.
- **Multiselect**: Select multiple layers or frames in Figma and import them all at once.
- **Full file import**: Quickly bring your entire Figma file onto Jitter's infinite canvas by pressing ⌘ + A (Ctrl + A on Windows) to select everything and then exporting.

## Other improvements

- Better artboard pasting: Pasting an artboard into a file will now position it in the middle of the viewport.
- Invalid media handling: If a file contains invalid or unavailable media, you will now see a warning in the righthand panel that will not prevent the file from being opened or exported.
- Bug fix: We fixed an issue where changes made when editing a template when logged out of Jitter were not saved.

<video src="https://assets.jitter.video/20250218-custom-easings.mp4" controls=""></video>

[Feb 17, 2025](https://jitter.video/changelog/2025-02-18-custom-easings/)
...
<video src="https://assets.jitter.video/20250204-infinite-canvas.mp4" controls=""></video>

[Feb 3, 2025](https://jitter.video/changelog/2025-02-04-infinite-canvas/)
...
- **Iterate faster** and quickly test ideas side by side.
- **Compare versions instantly** in one view – no more switching between files.
- **Easily scale your content** by adapting animations for different formats, languages, and platforms in one place.
- **Collaborate like never before** in real time, all in a single file.

You can add new artboards to your file in two ways:

- Click the *New Artboard* button in the top bar.
- Duplicate an existing artboard with:
	- ⌘ C / ⌘ V (ctrl C / ctrl V on Windows)
		- ⌘ D (ctrl D on Windows)
		- holding ⌥ while dragging (holding alt while dragging on Windows)

## Other improvements

- New shortcut: Use ⌥ L (or alt L on Windows) to collapse all layer groups, except the ones with the selected layer(s).
- New shortcut: Press ⌘ D (ctrl D on Windows) to duplicate operations in the timeline.
- New shortcut: Hit ⇧ 2 to pan and zoom the canvas to show the selected layer(s).
- Improvement: Double-click a layer icon in the layer list to pan and zoom the canvas to show the layer.
- Bug fix: We've fixed an issue where deleting a *Play* operation for video would delete the associated video layer.
- Bug fix: We've fixed a bug where text layers would occasionally not be visible after a new animation was added to them.
- Bug fix: Timeline snapping between operations is now restored.

<video src="https://assets.jitter.video/20250116-blur-presets.mp4" controls=""></video>

[Jan 15, 2025](https://jitter.video/changelog/2025-01-16-blur-presets/)
...
1. Choose a layer, switch to the *Animate* tab, and click *New Animation*.
2. Depending on the type of animations, you're looking for, select *In* or *Out*.
3. Scroll down to the *Blur* section and choose a preset you'd like to use.

## Other improvements

- Snapping improvement: Visible layers no longer snap with hidden layers.
- Big fixes: We've fixed several bugs that could cause the editor to crash when mask groups were ungrouped or when fonts weren't loaded.

<video src="https://assets.jitter.video/20241217-curved-paths.mp4" controls=""></video>

[Dec 16, 2024](https://jitter.video/changelog/2024-12-17-curved-paths/)
...
1. Choose a layer, switch to the *Animate* tab, and click *New Animation*.
2. In the *Custom* tab, select *Move*.
3. Adjust the path's anchor points to sculpt a curve that fits your idea.

Of course, you can also tweak duration and easing to ensure every movement feels just right.

## Other improvements

- Better snapping: We've made several improvements to snapping between layers.
- Better syncing: We've fixed an issue where a file could display a different version when opened on a different computer.
- Custom font fix: We've fixed an issue where valid font files would sometimes return an import error.

<video src="https://assets.jitter.video/20241119-community-templates.mp4" controls=""></video>

[Nov 18, 2024](https://jitter.video/changelog/2024-11-19-community-templates/)

## Community templates

Today, we're excited to announce our first drop of [community templates](https://jitter.video/community/), created by some of the best designers and design studios exclusively for Jitter! Browse and customize motion design templates by [Antinomy](https://jitter.video/community/antinomy/), [Anagram](https://jitter.video/community/anagram/), [Vendredi Society](https://jitter.video/community/vendredi-society/), [Studio Size](https://jitter.video/community/studio-size/), [Fons Mans](https://jitter.video/community/fons-mans/), [Luc Chaissac](https://jitter.video/community/luc-chaissac/), and more. Available now to all Jitter users, for free, no download necessary.

## Other improvements

- Copy & paste easings: You can now copy and paste easings across operations. To do that, select the operation whose easing you'd like to copy, click *...* next to Animation in the right-hand sidebar, and select *Copy easing*. Next, select the operation you'd like to apply the easing to, and hit ⌘ + V (or Ctrl + V on Windows).

<video src="https://assets.jitter.video/20241030-new-lottie-exporter.mp4" controls=""></video>

[Oct 29, 2024](https://jitter.video/changelog/2024-10-30-new-lottie-exporter/)
...
- Better snapping: We’ve significantly improved snapping, especially when working with nested, rotated layers, for a more intuitive feel.
- Improved performance: We’ve made several behind-the-scenes performance tweaks for a faster, more seamless experience when working with the timeline and the file list.

<video src="https://assets.jitter.video/20241015-blur.mp4" controls=""></video>

[Oct 14, 2024](https://jitter.video/changelog/2024-10-15-blur/)

## Blur

You can now add blur to your layers and animations in Jitter! With this latest update, you can:

- Add depth of field and focus points to your videos
- Create dreamy gradient blurs
- Add bokeh effects to your animations
- Create organic transitions and elegant text animations
- Apply beautiful mask feathers And more!

Here's how you can access the blur effect in Jitter:

- To add blur to a layer, select the layer in your Jitter file, make sure you're in the *Design* tab in the right-hand sidebar, and click on *Blur* at the bottom. You can also adjust the intensity of the blur by changing the value in the *Radius* field.
- To create a blur animation, select the layer you'd like to animate, and make sure you're in the *Animate* tab in the right-hand sidebar. Click on *New Animation* -> *Custom* -> *Blur*, adjust the params, and you're done!

## Other improvements

- Faster file list: Your file list is now much faster to load and scroll.
- Lottie fixes: A few improvements for better Lottie export.
- Bug fix: We've fixed occasional crashes that could occur when updating the font of text imported from Figma.

<video src="https://assets.jitter.video/20240916-chart-templates.mp4" controls=""></video>

[Sep 15, 2024](https://jitter.video/changelog/2024-09-16-chart-templates/)

## Chart templates

This week, we are shipping a collection of [animated chart templates](https://jitter.video/templates/charts/) you can customize to bring your data visualizations to life. In this new collection, you'll find the most common chart types – bar, line, pie, and donut – with various versions of each chart. Feel free to use these templates for a variety of projects, from product design and business presentations to social media content and educational visuals.

## Other improvements

- Better audio compatibility: We've improved the audio format for exported files, making it compatible with most players and video editing apps.
- Animated download button: The download button on the export page is now animated so it's instantly visible.

<video src="https://assets.jitter.video/20240902-jitter-new.mp4" controls=""></video>

[Sep 1, 2024](https://jitter.video/changelog/2024-09-02-jitter-new/)

## jitter.new

You can now create a new Jitter file right from your browser's address bar! Just type `jitter.new` in any browser, and, if you are logged into your account, you'll land right in the Jitter editor with a new file open.

## Other improvements

- Offline / syncing indicator: When working on a Jitter file, you'll now be notified if you're offline or if your changes are being synced to the server, and your collaborators might not be able to see your updates right away.

<video src="https://assets.jitter.video/20240820-alignment-tools.mp4" controls=""></video>

[Aug 19, 2024](https://jitter.video/changelog/2024-08-20-alignment-tools/)
...
- Drag & drop away: You can now drag and drop media into the entire Jitter editor window, not just the canvas.
- Big files render faster: We've improved performance for files with complex compositions, which means bigger files will now render faster.

<video src="https://assets.jitter.video/20240806-reorder-folders.mp4" controls=""></video>

[Aug 5, 2024](https://jitter.video/changelog/2024-08-06-reordering-folders/)
...
- Lighter audio files: This means faster, smoother audio import and much smaller exported file size.
- Bug fix: We've fixed the bug that could occasionally cause app crashes when working with empty text layers, timeline selections, and dragging layers.
- Bug fix: Sync issues across devices after creating a file have been fixed, meaning your files will now always be up-to-date across different devices and browsers.

<video src="https://assets.jitter.video/20240723-audio-release.mp4" controls=""></video>

[Jul 22, 2024](https://jitter.video/changelog/2024-07-23-audio/)
...
- Opacity shortcut: You can now change a layer's opacity by selecting it and pressing the digits on your keyboard: from 1 (for 10%) to 0 (for 100%).
- Faster loading files: Files with large assets now open faster.

<video src="https://assets.jitter.video/20240605-gradient-animations.mp4" controls=""></video>

[Jun 4, 2024](https://jitter.video/changelog/2024-06-05-gradient-animations/)
...
1. Select your layer and click *New animation*
2. Add a *Color* animation from the *Custom* tab in the animation menu
3. Edit the final state of your gradient And that's it!

You can animate all the gradient properties, including:

- The color, number, and position of the color stops
- The position of the gradient on the canvas

You can also adjust the duration and easing of your transition to create exactly the effect you want.

<video src="https://assets.jitter.video/20240507-lottie-mask-animations.mp4" controls=""></video>

[May 6, 2024](https://jitter.video/changelog/2024-05-07-lottie-mask-animations/)
...
<video src="https://assets.jitter.video/20240429-multi-select-files.mp4" controls=""></video>

[Apr 28, 2024](https://jitter.video/changelog/2024-04-29-multi-select-files/)
...
<video src="https://assets.jitter.video/20240404-gradient_powermove.mp4" controls=""></video>

[Apr 3, 2024](https://jitter.video/changelog/2024-04-04-gradient-shortcuts/)
...
<video src="https://assets.jitter.video/20240327-file-sharing.mp4" controls=""></video>

[Mar 26, 2024](https://jitter.video/changelog/2024-03-27-file-sharing/)
...
<video src="https://assets.jitter.video/20240320-boomerang.mp4" controls=""></video>

[Mar 19, 2024](https://jitter.video/changelog/2024-03-20-boomerang-export/)
...
<video src="https://assets.jitter.video/20240313-gradients.mp4" controls=""></video>

[Mar 12, 2024](https://jitter.video/changelog/2024-03-13-gradients/)
...
<video src="https://assets.jitter.video/20240228-jitter-community-is-live.mp4" controls=""></video>

[Feb 27, 2024](https://jitter.video/changelog/2024-02-28-jitter-community-is-live/)
...
Join us 👉 [https://discord.gg/FhZEmxZJ6e](https://discord.gg/FhZEmxZJ6e)

<video src="https://assets.jitter.video/20240208-folders-for-teams.mp4" controls=""></video>

[Feb 7, 2024](https://jitter.video/changelog/2024-02-08-folders-for-teams/)
...
Folders start rolling out for teams on the Jitter Pro plan.

<video src="https://assets.jitter.video/20240131-onboarding-invite-teammates.mp4" controls=""></video>

[Jan 30, 2024](https://jitter.video/changelog/2024-01-31-onboarding-invite-teammates/)
...
<video src="https://assets.jitter.video/20231220-distance-snapping.mp4" controls=""></video>

[Dec 19, 2023](https://jitter.video/changelog/2023-12-20-distance-snapping/)
...
<video src="https://assets.jitter.video/20231206-onboarding.mp4" controls=""></video>

[Dec 5, 2023](https://jitter.video/changelog/2023-12-06-new-onboarding-flow/)
...
If you are an existing user, you can initiate this first-time introduction by typing [jitter.video/onboarding](https://jitter.video/onboarding) in your address bar.
...
<video src="https://assets.jitter.video/20231129-text-animations-in-lottie.mp4" controls=""></video>

[Nov 28, 2023](https://jitter.video/changelog/2023-11-29-text-animations-in-lottie/)
...
<video src="https://assets.jitter.video/20231115-keyboard-shortcuts.mp4" controls=""></video>

[Nov 14, 2023](https://jitter.video/changelog/2023-11-15-keyboard-shortcuts/)
...
<video src="https://assets.jitter.video/20231108-custom-easings.mp4" controls=""></video>

[Nov 7, 2023](https://jitter.video/changelog/2023-11-08-easings-intensity/)
...
<video src="https://assets.jitter.video/20231018-performance-improvements.mp4" controls=""></video>

[Oct 17, 2023](https://jitter.video/changelog/2023-10-18-performance-improvements/)
...
<video src="https://assets.jitter.video/20230927-live-avatars.mp4" controls=""></video>

[Sep 26, 2023](https://jitter.video/changelog/2023-09-27-live-avatars/)
...
<video src="https://assets.jitter.video/20230906-search-fonts.mp4" controls=""></video>

[Sep 5, 2023](https://jitter.video/changelog/2023-09-06-search-fonts/)
...
<video src="https://assets.jitter.video/20230816-new-animated-device-templates.mp4" controls=""></video>

[Aug 15, 2023](https://jitter.video/changelog/2023-08-16-new-animated-device-templates/)
...
To access the new animated device templates in Jitter, simply navigate to the [Templates](https://jitter.video/templates/) section, click on the [Devices](https://jitter.video/templates/devices/) category, and select the desired template that best suits your project's needs.
...
<video src="https://assets.jitter.video/20230719-4K-exports.mp4" controls=""></video>

[Jul 18, 2023](https://jitter.video/changelog/2023-07-19-4k-exports/)
...
<video src="https://assets.jitter.video/20230715-jitter-for-teams.mp4" controls=""></video>

[Jul 4, 2023](https://jitter.video/changelog/2023-07-05-jitter-for-teams/)
...
You and your team can now have all your files in the same workspace. And you always get the latest version: no more tedious file sharing, endless back-and-forth exchanges, or final\_final\_v2 versions. Everything is always in sync, and you are all on the same page.
...
<video src="https://assets.jitter.video/20230614-improved-gif-export.mp4" controls=""></video>

[Jun 13, 2023](https://jitter.video/changelog/2023-06-14-improved-gif-export/)
...
<video src="https://assets.jitter.video/20230607-timeline-selection-rectangle.mp4" controls=""></video>

[Jun 6, 2023](https://jitter.video/changelog/2023-06-07-timeline-selection-rectangle/)
...
<video src="https://assets.jitter.video/20230529-template-categories.mp4" controls=""></video>

[May 28, 2023](https://jitter.video/changelog/2023-05-29-template-categories/)
...
<video src="https://assets.jitter.video/20230522-copy-and-paste-from-figma.mp4" controls=""></video>

[May 21, 2023](https://jitter.video/changelog/2023-05-22-copy-and-paste-from-figma/)

## Copy and paste from Figma

We are thrilled to announce the latest version of our [Figma plugin](https://www.figma.com/community/plugin/961270034818256057).
...
This new plugin is much more flexible and is designed to support exciting future updates. You can install the new plugin from [Figma Community](https://www.figma.com/community/plugin/961270034818256057), and we can’t wait to see how it speeds up your workflow!
...
<video src="https://assets.jitter.video/20230414-timeline-keyboard-navigation.mp4" controls=""></video>

[Apr 13, 2023](https://jitter.video/changelog/2023-04-14-timeline-keyboard-navigation/)
...
<video src="https://assets.jitter.video/20230406-new-templates.mp4" controls=""></video>

[Apr 5, 2023](https://jitter.video/changelog/2023-04-06-new-templates/)
...
- Added the option to replace a layer or operation when pasting, using ⌘ ⇧ V (ctrl shift V on Windows).
...
<video src="https://assets.jitter.video/20230309-select%E2%88%92multiple-objects.mp4" controls=""></video>

[Mar 8, 2023](https://jitter.video/changelog/2023-03-09-select-multiple-objects/)
...
<video src="https://assets.jitter.video/20230223-hover-layers.mp4" controls=""></video>

[Feb 22, 2023](https://jitter.video/changelog/2023-02-23-hover-layers/)
...
<video src="https://assets.jitter.video/20230207-background-export.mp4" controls=""></video>

[Feb 6, 2023](https://jitter.video/changelog/2023-02-07-background-export/)
...
<video src="https://assets.jitter.video/20230131-lock-and-unlock-layers.mp4" controls=""></video>

[Jan 30, 2023](https://jitter.video/changelog/2023-01-31-lock-and-unlock-layers/)
...
<video src="https://assets.jitter.video/20230120-animated-file-thumbnails.mp4" controls=""></video>

[Jan 19, 2023](https://jitter.video/changelog/2023-01-20-animated-file-thumbnails/)
...
<video src="https://assets.jitter.video/20230110-all-new-jitter.mp4" controls=""></video>

[Jan 9, 2023](https://jitter.video/changelog/2023-01-10-all-new-jitter/)
...
<video src="https://assets.jitter.video/20221201-new-templates.mp4" controls=""></video>

[Nov 30, 2022](https://jitter.video/changelog/2022-12-01-new-website-loader-story-templates/)

## New website, loader and story templates

This week, we are adding a bunch of new professionally designed templates to the [example gallery](https://jitter.video/templates/). You'll find 3 main categories:
...
<video src="https://assets.jitter.video/20221117-customer-portal.mp4" controls=""></video>

[Nov 16, 2022](https://jitter.video/changelog/2022-11-17-customer-portal/)
...
1. Click **Manage billing** from your [account](https://jitter.video/account/) page.
...
<video src="https://assets.jitter.video/20221102-rich-text-editing.mp4" controls=""></video>

[Nov 1, 2022](https://jitter.video/changelog/2022-11-02-rich-text-editing/)
...
<video src="https://assets.jitter.video/20221019-svg-to-lottie.mp4" controls=""></video>

[Oct 18, 2022](https://jitter.video/changelog/2022-10-19-svg-to-lottie/)
...
<video src="https://assets.jitter.video/20221005-distance-to-objects.mp4" controls=""></video>

[Oct 4, 2022](https://jitter.video/changelog/2022-10-05-distance-between-objects/)
...
<video src="https://assets.jitter.video/20220921-selection-rectangle.mp4" controls=""></video>

[Sep 20, 2022](https://jitter.video/changelog/2022-09-21-selection-rectangle/)
...
<video src="https://assets.jitter.video/20220614-inline-text-editing.mp4" controls=""></video>

[Jun 13, 2022](https://jitter.video/changelog/2022-06-14-inline-text-editing/)
...
<video src="https://assets.jitter.video/20220525-figma-plugin-dark-mode.mp4" controls=""></video>

[May 24, 2022](https://jitter.video/changelog/2022-05-25-figma-plugin-dark-mode/)
...
<video src="https://assets.jitter.video/20220510-crisp-texts-in-lottie.mp4" controls=""></video>

[May 9, 2022](https://jitter.video/changelog/2022-05-10-crisp-texts-in-lottie/)
...
<video src="https://assets.jitter.video/20220503-figma_to_lottie.mp4" controls=""></video>

[May 2, 2022](https://jitter.video/changelog/2022-05-03-figma-to-lottie/)
...
<video src="https://assets.jitter.video/20220420-lottie_export_beta.mp4" controls=""></video>

[Apr 19, 2022](https://jitter.video/changelog/2022-04-20-lottie-export/)
...
<video src="https://assets.jitter.video/20220225-transparent_gif_export.mp4" controls=""></video>

[Feb 24, 2022](https://jitter.video/changelog/2022-02-25-transparent-gif-export/)
...
<video src="https://assets.jitter.video/20220114-gifs.mp4" controls=""></video>

[Jan 13, 2022](https://jitter.video/changelog/2022-01-14-import-gifs/)
...
<video src="https://assets.jitter.video/20211216-masks.mp4" controls=""></video>

[Dec 15, 2021](https://jitter.video/changelog/2021-12-16-masks/)
...
<video src="https://assets.jitter.video/20211029-svg.mp4" controls=""></video>

[Oct 28, 2021](https://jitter.video/changelog/2021-10-29-edit-svgs-natively/)
...
<video src="https://assets.jitter.video/20211019-transparent_bg.mp4" controls=""></video>

[Oct 18, 2021](https://jitter.video/changelog/2021-10-19-transparent-background-export/)
...
<video src="https://assets.jitter.video/20210920-loop_playback.mp4" controls=""></video>

[Sep 19, 2021](https://jitter.video/changelog/2021-09-20-loop-playback-preview/)
...
<video src="https://assets.jitter.video/20210909-timeline_snapping.mp4" controls=""></video>

[Sep 8, 2021](https://jitter.video/changelog/2021-09-09-animation-snapping/)
...
<video src="https://assets.jitter.video/20210826-rename_inline.mp4" controls=""></video>

[Aug 25, 2021](https://jitter.video/changelog/2021-08-26-rename-layers-inline/)
...
<video src="https://assets.jitter.video/20210813-video.mp4" controls=""></video>

[Aug 12, 2021](https://jitter.video/changelog/2021-08-13-video-support/)
...
<video src="https://assets.jitter.video/20210708-stroke.mp4" controls=""></video>

[Jul 7, 2021](https://jitter.video/changelog/2021-07-08-stroke/)
...
<video src="https://assets.jitter.video/20210701-duplicate.mp4" controls=""></video>

[Jun 30, 2021](https://jitter.video/changelog/2021-07-01-duplicate-layers-by-holding-kbdaltkbd-while-dragging/)
...
<video src="https://assets.jitter.video/20210621-hide_show.mp4" controls=""></video>

[Jun 20, 2021](https://jitter.video/changelog/2021-06-21-hide--show-animations/)
...
<video src="https://assets.jitter.video/20210609-multi_edit.mp4" controls=""></video>

[Jun 8, 2021](https://jitter.video/changelog/2021-06-09-edit-multiple-layers-or-animations-simultaneously/)
...
<video src="https://assets.jitter.video/20210531-letter_spacing.mp4" controls=""></video>

[May 30, 2021](https://jitter.video/changelog/2021-05-31-letter-spacing-support/)
...
<video src="https://assets.jitter.video/20210520-new_text_effects.mp4" controls=""></video>

[May 19, 2021](https://jitter.video/changelog/2021-05-20-new-text-effect-menu/)
...
<video src="https://assets.jitter.video/20210513-timeline_zoom.mp4" controls=""></video>

[May 12, 2021](https://jitter.video/changelog/2021-05-13-timeline-zoom/)
...
<video src="https://assets.jitter.video/20210510-figma_sync.mp4" controls=""></video>

[May 9, 2021](https://jitter.video/changelog/2021-05-10-sync-figma-projects/)
...
<video src="https://assets.jitter.video/20210503-initial_value.mp4" controls=""></video>

[May 2, 2021](https://jitter.video/changelog/2021-05-03-animations-with-initial-value/)
...
<video src="https://assets.jitter.video/20210415-figma.mp4" controls=""></video>

[Apr 14, 2021](https://jitter.video/changelog/2021-04-15-figma-plugin/)

## Figma plugin

Our Figma plugin just got published on Figma Community: you can [install it here](https://www.figma.com/community/plugin/961270034818256057)! This plugin allows you in import a Figma project into Jitter, which means that you don't need to recreate the design from scratch in Jitter anymore. This is a huge time saver.
...
<video src="https://assets.jitter.video/20210408-group_clipping.mp4" controls=""></video>

[Apr 7, 2021](https://jitter.video/changelog/2021-04-08-clipping-groups/)
...
<video src="https://assets.jitter.video/20210331-fast_export.mp4" controls=""></video>

[Mar 30, 2021](https://jitter.video/changelog/2021-03-31-super-fast-video-export-/)
...
<video src="https://assets.jitter.video/20210310-groups.mp4" controls=""></video>

[Mar 9, 2021](https://jitter.video/changelog/2021-03-10-grouping-layers/)

## Grouping layers

You can now select multiple layers and create a group with them! To do this, you can simply select the layers you want to group, and press ⌘ G (or ctrl G on Windows). If you want to ungroup them, you can simply select the group, and press ⇧ ⌘ G (or ⇧ ctrl G on Windows).
...
<video src="https://assets.jitter.video/20210224-bug_fixes.mp4" controls=""></video>

[Feb 23, 2021](https://jitter.video/changelog/2021-02-24-improvements--fixes/)
...
<video src="https://assets.jitter.video/20210217-timeline_scroll.mp4" controls=""></video>

[Feb 16, 2021](https://jitter.video/changelog/2021-02-17-scrollable-timeline/)
...
<video src="https://assets.jitter.video/20210209-video.mp4" controls=""></video>

[Feb 8, 2021](https://jitter.video/changelog/2021-02-09-jitter-is-now-in-public-beta/)
...
<video src="https://assets.jitter.video/20210129-export_menu.mp4" controls=""></video>

[Jan 28, 2021](https://jitter.video/changelog/2021-01-29-export-menu/)
...
<video src="https://assets.jitter.video/20210122-text_presets.mp4" controls=""></video>

[Jan 21, 2021](https://jitter.video/changelog/2021-01-22-text-presets/)
...
<video src="https://assets.jitter.video/20210115-presets.mp4" controls=""></video>

[Jan 14, 2021](https://jitter.video/changelog/2021-01-15-animation-presets/)
...
<video src="https://assets.jitter.video/20201219-group_animations.mp4" controls=""></video>

[Dec 18, 2020](https://jitter.video/changelog/2020-12-19-group-animations-in-the-timeline/)
...
<video src="https://assets.jitter.video/20201211-copy_and_paste.mp4" controls=""></video>

[Dec 10, 2020](https://jitter.video/changelog/2020-12-11-copy--paste-animations/)
...
That's it! And of course, it also works with ctrl C and ctrl V on Windows and Linux.
...
- Added new examples to [the gallery](https://jitter.video/templates/)
- It is now possible to move a multi-selection of layers with the keyboard arrows

<video src="https://assets.jitter.video/20201204-gallery.mp4" controls=""></video>

[Dec 3, 2020](https://jitter.video/changelog/2020-12-04-example-gallery/)

## Example gallery

We are really excited to release the [gallery of examples](https://jitter.video/templates/). In this gallery, you can click on any example to explore how it was done, and duplicate the file to remix it.
...
<video src="https://assets.jitter.video/20201127-improvements.mp4" controls=""></video>

[Nov 26, 2020](https://jitter.video/changelog/2020-11-27-improvements-and-fixes/)
...
<video src="https://assets.jitter.video/20201120-ellipse.mp4" controls=""></video>

[Nov 19, 2020](https://jitter.video/changelog/2020-11-20-ellipse--arc-tool/)
...
<video src="https://assets.jitter.video/20201113-animate-design-modes.mp4" controls=""></video>

[Nov 12, 2020](https://jitter.video/changelog/2020-11-13-animate--design-modes/)
...
[Nov 5, 2020](https://jitter.video/changelog/2020-11-06-animate-elements-into-view/)
...
<video src="https://assets.jitter.video/20201030-improvements.mp4" controls=""></video>

[Oct 29, 2020](https://jitter.video/changelog/2020-10-30-improvements-and-fixes/)
...
[Oct 22, 2020](https://jitter.video/changelog/2020-10-23-project-sharing/)
...
[Oct 15, 2020](https://jitter.video/changelog/2020-10-16-grouping-layers/)

## Grouping layers

It is now possible to create groups of layers:

- When multiple layers are selected, press ⌘ G when multiple layers are selected to group them (use ctrl G on Windows / Linux)
- When a group is selected, press ⌘ ⇧ G to ungroup (or ctrl ⇧ G on Windows / Linux)
...
<video src="https://assets.jitter.video/20201009-masks.mp4" controls=""></video>

[Oct 8, 2020](https://jitter.video/changelog/2020-10-09-proof-of-concept-masks/)
...
[Oct 1, 2020](https://jitter.video/changelog/2020-10-02-snapping-layers/)
...
<video src="https://assets.jitter.video/20200925-rename-duplicate-files.mp4" controls=""></video>

[Sep 24, 2020](https://jitter.video/changelog/2020-09-25-rename-and-duplicate-files/)
...
[Sep 17, 2020](https://jitter.video/changelog/2020-09-18-create--edit-animations-graphically/)
...
![20200911-custom-fonts.png](https://assets.jitter.video/20200911-custom-fonts.png)

[Sep 10, 2020](https://jitter.video/changelog/2020-09-11-use-your-own-fonts/)
...
![20200904-animation-presets.png](https://assets.jitter.video/20200904-animation-presets.png)

[Sep 3, 2020](https://jitter.video/changelog/2020-09-04-animation-presets/)
...
![20200828-timeline-multiselect.png](https://assets.jitter.video/20200828-timeline-multiselect.png)

[Aug 27, 2020](https://jitter.video/changelog/2020-08-28-select-multiple-animations-in-the-timeline/)
...
<video src="https://assets.jitter.video/20200821-magic-motion.mp4" controls=""></video>

[Aug 20, 2020](https://jitter.video/changelog/2020-08-21-magic-motion-proof-of-concept/)

## Magic Motion proof-of-concept

This week, we worked on ways to simplify the creation of an animation. What if we could design the initial and final states of an element, and let the app magically create an animation between those 2 states? This is what we are testing at the moment: [reach out to us](mailto:hi@snackthis.co?subject=Hello%20SnackThis) if you want to give it a try!
...
[Aug 13, 2020](https://jitter.video/changelog/2020-08-14-checkout-process/)
...
![20200807-ui-revamp.png](https://assets.jitter.video/20200807-ui-revamp.png)

[Aug 6, 2020](https://jitter.video/changelog/2020-08-07-ui-revamp/)
...
<video src="https://assets.jitter.video/20200731-text-node-easing.mp4" controls=""></video>

[Jul 30, 2020](https://jitter.video/changelog/2020-07-31-text-effect-easing/)
...
<video src="https://assets.jitter.video/20200724-star-animation.mp4" controls=""></video>

[Jul 23, 2020](https://jitter.video/changelog/2020-07-24-star-shape/)
...
![20200717-file-library.png](https://assets.jitter.video/20200717-file-library.png)

[Jul 16, 2020](https://jitter.video/changelog/2020-07-17-file-library/)
...
![20200710-text-inspector.png](https://assets.jitter.video/20200710-text-inspector.png)

[Jul 9, 2020](https://jitter.video/changelog/2020-07-10-undo--redo/)
...
![20200703-opacity-inspector.png](https://assets.jitter.video/20200703-opacity-inspector.png)

[Jul 2, 2020](https://jitter.video/changelog/2020-07-03-more-control-over-the-animations/)
...
[Jun 25, 2020](https://jitter.video/changelog/2020-06-26-video-support/)
...
---
*Clipped from [jitter.video](https://jitter.video/changelog/?utm_source=broadcast&utm_medium=email&utm_campaign=may-2026) on 2026-05-13T15:11:52-04:00*
