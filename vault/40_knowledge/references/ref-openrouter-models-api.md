---
title: "OpenRouter Models - Unified Access to 300+ AI Models"
...
ai-context: "OpenRouter Models API reference — query parameters (output_modalities, supported_parameters) for filtering across 300+ models, RSS feed, and routing across providers via one endpoint."
---
Explore and browse 300+ models and providers [on our website](https://openrouter.ai/docs/models), or [with our API](https://openrouter.ai/docs/api-reference/models/get-models). You can also subscribe to our [RSS feed](https://openrouter.ai/docs/api/v1/models?use_rss=true) to stay updated on new models.
...
If you’re interested in working with OpenRouter, you can learn more on our [providers page](https://openrouter.ai/docs/guides/community/for-providers).

---
*Clipped from [openrouter.ai](https://openrouter.ai/docs/guides/overview/models) on 2026-05-11T14:17:35-04:00*
