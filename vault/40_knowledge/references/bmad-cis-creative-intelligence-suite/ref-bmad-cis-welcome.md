---
title: "Welcome"
source: "https://cis-docs.bmad-method.org/"
author:
published:
created: 2026-05-04
...
| Section | Purpose |
| --- | --- |
| **[Tutorials](https://cis-docs.bmad-method.org/tutorials/)** | Get started with CIS workflows |
| **[How-To Guides](https://cis-docs.bmad-method.org/how-to/)** | Practical guides for specific tasks |
| **[Explanation](https://cis-docs.bmad-method.org/explanation/)** | Learn how CIS works |
| **[Reference](https://cis-docs.bmad-method.org/reference/)** | Technical reference |

---

## Getting Started

New to CIS? Start with the [Getting Started tutorial](https://cis-docs.bmad-method.org/tutorials/getting-started/) to learn how to:
...
---
*Clipped from [bmad-method.org](https://cis-docs.bmad-method.org/) on 2026-05-04T06:16:19-04:00*
