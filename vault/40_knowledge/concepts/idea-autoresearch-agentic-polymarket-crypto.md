...
status: draft
ai-context: "Explore giving an AI agent a Coinbase wallet plus Block Pro data to autoresearch crypto and Polymarket markets as a side-income experiment, with guardrails."
created: 2026-04-15
source: vault/00_inbox
tags: [agents, crypto, polymarket, autoresearch]
---
...
People make money from giving agents access to knowledge and letting those agents work their magic. Obviously, there would have to be serious guardrails so I'm not hacked or drained, but this could be an interesting research process. We need to find ways to gather data (The Block Pro) and ways to take advantage of that data.
