...
## Monthly / Quarterly
- **Steve W. Chung starts as CEO 2026-05-01** (tech + media + global executive — ex-CJ ENM, FOX Corporation, Frankly, Azuki). [redacted] (President) serves as interim CEO through 2026-04-30. Ed + Sean are prepping a roadmap; The Block Pro revamp is the flagship pitch (biggest revenue line, not worked on in years).
