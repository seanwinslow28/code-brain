...
**(917) 886-1251** | [LinkedIn](https://linkedin.com) | [sean.winslow28@gmail.com](mailto:sean.winslow28@gmail.com) | [seanwinslow.com](https://seanwinslow.com) | Boston, MA

---

## Summary

Creative Product Manager. 12+ years of illustration and animation craft, now applied through AI-native production tooling. At The Block, automated AI media generation for the Campus 201 enterprise course launch (Nano Banana Pro / Veo / ElevenLabs), built a 50+ site competitive visual audit feeding the .co homepage redesign with the design team, and shipped the Polymarket × Campus B2B integration. Active 2D animation pipeline ships a portfolio short June 2026.
...
**Creative & Media Production:** 2D animation, illustration, storyboarding, character design, sprite art, video production (Remotion, ComfyUI, Adobe Creative Suite), AI media generation (Nano Banana 2, Veo 3.1, Kling 3.0, ElevenLabs, Seedance 2.0)

**AI / Agentic Engineering:** Claude Code, Claude Agent SDK, Claude Skills authoring, MCP (Model Context Protocol), prompt engineering, agent orchestration, RAG / local-LLM workflows (Ollama, SearXNG, Qwen3, gemma4)

**Product Craft:** PRD authoring, user research, competitive analysis, A/B testing, GA4 analytics, roadmap planning, OKR ownership, cross-functional facilitation, build-in-public

**Tools & Platforms:** Cursor, GitHub, Jira, Confluence, Slack, Figma, Notion, Zapier, Anthropic API, NotebookLM

**Domains:** Animation & illustration, media production, EdTech / online learning, crypto / digital assets, B2B SaaS
