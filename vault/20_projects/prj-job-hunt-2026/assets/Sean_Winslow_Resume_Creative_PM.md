...
- Architecture writeups for two production subsystems: Phase D Typed Reasoning Edges and Phase 6 Knowledge Loop (both detailed at `seanwinslow.com/transactions`).
...
**Tools & Platforms:** Cursor, GitHub, Python, SQLite, Jira, Confluence, Slack, Figma, Notion, Zapier, Anthropic API, NotebookLM

**Domains:** Animation & illustration, AI-assisted media production, EdTech / online learning, crypto / digital assets, B2B SaaS
