# Sean Winslow — Resume Council Input (2026-05-17)

> **Read-only consolidation** of the master + AI PM variant for the 2026-05-18 LLM Council pass.
> Underlying canonical files: [`Sean_Winslow_Resume.md`](Sean_Winslow_Resume.md) and [`Sean_Winslow_Resume_AI_PM.md`](Sean_Winslow_Resume_AI_PM.md).
> Edits to those files do NOT auto-propagate here — re-export this doc if either underlying file changes before council invocation.
> Patches applied 2026-05-17 (Task 2.2 of [resume-council plan](../onwards-and-upwards-5-4-26/job-hunt-2026-roadmap/2026-05-17-resume-council-plan.md)):
> (1) LinkedIn URL fixed `linkedin.com` → real profile;
