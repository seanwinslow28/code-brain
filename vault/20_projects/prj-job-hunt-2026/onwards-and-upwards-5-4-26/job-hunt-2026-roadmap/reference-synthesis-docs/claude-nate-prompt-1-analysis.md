...
- *Publish:* GitHub README of `claude-superuser-pack` (make repo public if not already), Substack post linking to it, LinkedIn post with the Loom embedded, X thread.
