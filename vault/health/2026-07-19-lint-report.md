...
_270 finding(s) withheld from this tracked report (SOUL-derived, or about a file in a gitignored subtree). They remain counted below; full detail is in `vault/health/private/2026-07-19-private-findings.md` (local-only, gitignored). Backfilled 2026-09-03._
...
- **soul-tier-a-conflict** (T2): `knowledge/concepts/standardization-of-ai-interaction.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
...
- **soul-tier-a-conflict** (T2): `knowledge/concepts/the-engineer-creative-divide-in-tooling.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
...
- **soul-tier-a-conflict** (T2): `knowledge/concepts/the-verification-governance-inversion-in-agentic-workflows.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
- **soul-tier-a-conflict** (T2): `knowledge/concepts/throughput-vs-taste-memory-tension.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
