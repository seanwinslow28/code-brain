# Knowledge Lint Report — 2026-09-20

_1684 issues found (1402 structural, 282 semantic)._

_Tier-2 LLM scan: reviewed 4/4 concept batches._

_338 finding(s) withheld from this tracked report (SOUL-derived, or about a file in a gitignored subtree). They remain counted below; full detail is in `/Users/seanwinslow/Code-Brain/code-brain/vault/health/private/2026-09-20-private-findings.md` (local-only, gitignored)._
...
- **contradiction** (T2): `knowledge/concepts/agentic-engineering-signal.md` — contradicts the-illusion-of-competence-in-automated-systems (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/context-compounding.md` — contradicts operational-visibility-vs-semantic-value-in-agent-fleets (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/control-room-observability.md` — contradicts operational-uptime-vs-semantic-value-in-agent-fleets (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/cross-domain-bridging.md` — contradicts infrastructure-fragmentation-and-semantic-isolation (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/gatekeeping-via-metadata-precision.md` — contradicts silent-decay-in-strategic-pipelines (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/harness-engineering-invariant.md` — contradicts the-taste-throughput-trade-off-in-agentic-synthesis (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/legibility-debt-as-a-supervision-failure-mode.md` — contradicts privacy-aware-data-routing (source=sql)
- **contradiction** (T2): `knowledge/concepts/legibility-debt-as-a-supervision-failure-mode.md` — contradicts the-director-intern-invariant-in-creative-and-professional-identity (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/manufactured-finding.md` — contradicts convergence-rule-for-agentic-audits (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/negative-capability-failure-literacy.md` — contradicts the-illusion-of-competence-in-automated-systems (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/operational-uptime-vs-cognitive-utility-tension.md` — contradicts epistemic-artifacts-as-strategic-proof (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/operational-uptime-vs-semantic-value-in-agent-fleets.md` — contradicts legibility-debt-as-a-supervision-failure-mode (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/operational-visibility-vs-semantic-value-in-agent-fleets.md` — contradicts the-paradox-of-agentic-efficiency-vs-creative-authority (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/principal-agent-trust-deficit-in-automated-agents.md` — contradicts mental-transaction-costs-as-the-primary-constraint (source=sql)
- **contradiction** (T2): `knowledge/concepts/privacy-aware-data-routing.md` — contradicts legibility-debt-as-a-supervision-failure-mode (source=sql)
- **contradiction** (T2): `knowledge/concepts/privacy-aware-data-routing.md` — contradicts the-masking-effect-of-structural-completeness-in-failed-automation (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/supervision-as-the-new-ai-edge.md` — contradicts centralized-distribution-mechanism (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/supervision-as-the-new-ai-edge.md` — contradicts selection-effects-created-by-product-architecture (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/the-director-intern-invariant-in-creative-and-professional-identity.md` — contradicts supervision-as-the-new-ai-edge (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/the-efficiency-quality-inversion-in-automated-synthesis.md` — contradicts knowledge-centered-service (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/the-homogenization-trap-in-agentic-creative-workflows.md` — contradicts demonstration-over-declaration (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/the-illusion-of-competence-in-automated-systems.md` — contradicts epistemic-artifacts-as-strategic-proof (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/the-illusion-of-competence-in-automated-systems.md` — contradicts operational-visibility-vs-semantic-value-in-agent-fleets (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/the-masking-effect-of-structural-completeness-in-failed-automation.md` — contradicts privacy-aware-data-routing (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/the-syndication-trap.md` — contradicts passive-monitoring-commoditization (source=sql)
...
- **contradiction** (T2): `knowledge/concepts/agent-health.md` — These articles define 'agent health' as a metric of operational continuity where a running process that produces empty or stale output indicates a latent failure in context management. This implies that 'health' is strictly tied to semantic utility and data freshness, not just process completion. However, `knowledge/concepts/automation-reliability.md` posits that automated systems must prioritize deterministic execution and fault tolerance (availability) over optimal output quality when operating in unattended environments, stating a reliable but lower-fidelity check is superior to an unreliable high-fidelity one. This creates a tension: the 'health' definition demands semantic integrity as a prerequisite for validity, while the 'reliability' principle suggests that mere execution availability (even with lower fidelity) is the primary invariant for unattended systems.
- **contradiction** (T2): `knowledge/concepts/curation-as-the-new-scarcity.md` — `curation-as-the-new-scarcity.md` argues that in an age of cheap information generation, the primary value shift is from access to curation, specifically identifying 'structural gaps' (absence of information) as a signal. `comprehension-debt.md` describes the accumulation of unverified or poorly understood artifacts resulting from the gap between generation speed and verification capacity. The contradiction lies in the treatment of 'volume': `curation-as-the-new-scarcity` suggests that high volume is manageable if curation is strong, whereas `comprehension-debt` implies that high generation speed inherently creates a debt that compounds silently until maintenance costs exceed value, suggesting that without strict verification limits (not just curation), the system becomes unmanageable regardless of curation efforts.
- **contradiction** (T2): `knowledge/concepts/defensible-edge-mapping.md` — Both concepts advocate for positioning the creator as an architect of taste/judgment rather than a producer of volume. While not strictly contradictory, they overlap significantly in their core thesis (taste > output) without cross-referencing each other, creating redundancy in the knowledge graph regarding career strategy.
- **contradiction** (T2): `knowledge/concepts/legibility-debt-as-a-supervision-failure-mode.md` — `legibility-debt` describes a failure mode where automation efficacy depends on opaque state anchors invisible to monitoring. `demonstration-over-declaration` prescribes exposing the process of reasoning as the primary method for establishing credibility. The contradiction lies in the tension between 'opaque state anchors' (which hide context) and 'exposing reasoning' (which reveals context). If legibility debt is present, demonstration becomes impossible or misleading, yet `demonstration-over-declaration` assumes the infrastructure exists to support that exposure.
- **contradiction** (T2): `knowledge/concepts/goodgoodhart-failure-typing.md` — These two files describe the exact same failure mode (Goodhart's Law in AI agents) with nearly identical definitions and examples. `goodgoodhart-failure-typing.md` appears to be a duplicate or variant of `goodhart-failure-typing.md` without adding distinct nuance, creating semantic noise.
- **contradiction** (T2): `knowledge/concepts/the-automation-paradox-in-personal-knowledge-infrastructure.md` — These articles describe a systemic failure mode where increased automation velocity leads to semantic decay, legibility debt, and 'slop,' arguing that the human must intervene to repair structural fragmentation. This contradicts the operational reality described in the SOUL context (creative-studio & life-systems) where Sean actively relies on high-velocity automated synthesis (Claude Code, Agent SDK fleet, ComfyUI, Seedance/NB2 pipelines) as a core strength and enabler of his workflow, not a source of unmanageable decay. The SOUL context treats these tools as 'load-bearing' and 'pipeline staples' that enable creation, whereas the concepts frame such velocity as inherently destructive to strategic utility.
- **contradiction** (T2): `knowledge/concepts/the-taste-throughput-trade-off-in-agentic-synthesis.md` — These articles posit that scaling agent fleets creates a non-linear cognitive load on the human supervisor, creating a 'hard cap' where verification latency outpaces generation gains. This contradicts the SOUL context's explicit design principle of '90/10 delegation' and the successful operation of a 6-agent fleet (vault indexer, synthesizer, meta-agent, etc.) without reported supervisory fatigue as a blocker. The SOUL context frames the agents as enabling momentum ('creative momentum') rather than creating a bottleneck that requires reduction of active agents.
- **contradiction** (T2): `knowledge/concepts/the-skill-atrophy-trap-in-agentic-workflows.md` — These articles warn that automation removes routine cognitive practice, leading to skill atrophy and dependency on the tool. This contradicts the SOUL context's 'Sacred Cows' and operational reality where Sean explicitly states 'Create for ourselves' and uses AI as a partner to 'put things into the world we wish already existed,' maintaining active control over taste and direction ('Creative taste is Sean's, always'). The SOUL context views the tools as extensions of creative authority, not replacements that erode it.
- **contradiction** (T2): `knowledge/concepts/vault-as-agent-infrastructure.md` — Semantic tension regarding the nature of the vault. 'vault-as-agent-infrastructure' defines the vault as an active control plane requiring explicit design for state survival and handoffs, implying a complex, dynamic system. 'vault-maintenance' describes it through the lens of low-cost, automated curation to prevent technical debt, which risks treating it as a passive archive or simple storage layer rather than the active orchestration surface described in the infrastructure concept.
- **contradiction** (T2): `knowledge/concepts/trajectory-evaluation-vs-final-state-grading.md` — Contradiction in evaluation methodology. 'trajectory-evaluation' argues for continuous monitoring of process integrity (tool calls, context adherence) over binary outcome grading. 'vault-synthesizer-eval-suite' references a flaw where the judge was included in the candidate pool, implying a reliance on internal validation mechanisms that may not align with the external, process-focused trajectory evaluation required to avoid 'verification-governance inversion'.
- **contradiction** (T2): `knowledge/concepts/velocity-vs-judgment-in-mcp-strengthening.md` — Contradiction in human-AI role definition. 'velocity-vs-judgment' warns that high sampling velocity forces a trade-off where human judgment is sacrificed for speed, leading to semantic drift. 'vibe-coding-interview-format' posits the human as a 'navigator' while AI is the 'driver,' suggesting a model where high-velocity AI execution is the primary mode of operation, potentially exacerbating the judgment sacrifice warned against in the velocity concept.

## HIGH (189)

- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/00_inbox/tickets.md` — feedback_filter_repo_replace_text_collateral
...
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/connections/the-trust-verification-wedge-in-agentic-labor-markets.md` — Passive Metering Invariant
...
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/connections/metadata-precision-vs-strategic-relevance-in-knowledge-acquisition.md` — Gatekeeping via Metadata Precision
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/connections/the-remediation-gap-in-agentic-reputation-management.md` — The Syndication Trap
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/connections/the-remediation-gap-in-agentic-reputation-management.md` — Passive Monitoring Commoditization
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/connections/the-remediation-gap-in-agentic-reputation-management.md` — Attribution via Control Groups
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/connections/the-tension-between-parallel-throughput-and-sequential-integrity-in-agentic-fleets.md` — Serialization as a Correctness Gate
...
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/connections/the-tension-between-automation-velocity-and-human-calibration-limits.md` — Criteria Drift as a Systemic Risk
...
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/connections/trust-deficit-vs-mental-cost-in-agent-adoption.md` — Principal-Agent Trust Deficit in Automated Agents
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/connections/trust-deficit-vs-mental-cost-in-agent-adoption.md` — Mental Transaction Costs as the Primary Constraint
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/connections/trust-deficit-vs-mental-cost-in-agent-adoption.md` — The Impossibility of Automatic Low-Value Decisions
...
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/concepts/the-remediation-gap-in-agentic-reputation-management.md` — The Syndication Trap
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/concepts/the-remediation-gap-in-agentic-reputation-management.md` — Passive Monitoring Commoditization
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/concepts/the-remediation-gap-in-agentic-reputation-management.md` — Attribution via Control Groups
...
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/research/deep-dives/2026-06-09-agentic-engineering-intent-eval-governance-gaps.md` — voiceprint-plugin-build-spec
- **broken-wikilink** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/research/deep-dives/2026-06-09-agentic-engineering-intent-eval-governance-gaps.md` — vault-knowledge
- **retired-runtime-instruction** (T1): `.claude/skills/writing-voice-modes/references/voice-samples.md` — line 202: Quarantined Full Exercise Passages matches 'Full Exercise Passages'; decision: https://github.com/seanwinslow28/code-brain/issues/224
...
- **soul-tier-a-conflict** (T2): `knowledge/concepts/centralized-distribution-mechanism.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
...
- **soul-tier-a-conflict** (T2): `knowledge/concepts/job-hunt-as-sales-pipeline.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
- **soul-tier-a-conflict** (T2): `knowledge/concepts/energy-management.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
- **soul-tier-a-conflict** (T2): `knowledge/concepts/distribution-surface.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
- **soul-tier-a-conflict** (T2): `knowledge/concepts/failure-amplification-in-agentic-chains.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
- **soul-tier-a-conflict** (T2): `knowledge/concepts/humor-and-status-dynamics.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
...
- **soul-tier-a-conflict** (T2): `knowledge/concepts/privacy-aware-data-routing.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
- **soul-tier-a-conflict** (T2): `knowledge/concepts/throughput-vs-activity-illusion-in-job-hunt-operations.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
...
- **soul-tier-a-conflict** (T2): `knowledge/concepts/unified-roadmap.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
- **soul-tier-a-conflict** (T2): `knowledge/concepts/vault-knowledge-mcp-research.md` — detail withheld from this tracked report (SOUL-derived); see the local-only sidecar named in the header
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/concepts/the-remediation-gap-in-agentic-reputation-management.md` — knowledge/concepts/the-remediation-gap-in-agentic-reputation-management.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/concepts/operational-uptime-vs-semantic-value-in-agent-fleets.md` — knowledge/concepts/operational-uptime-vs-semantic-value-in-agent-fleets.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/concepts/the-extraction-fidelity-trap-in-knowledge-infrastructure.md` — knowledge/concepts/the-extraction-fidelity-trap-in-knowledge-infrastructure.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/expansions/trajectory-evaluation-vs-final-state-grading.md` — knowledge/expansions/trajectory-evaluation-vs-final-state-grading.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/expansions/the-efficiency-quality-inversion-in-automated-synthesis.md` — knowledge/expansions/the-efficiency-quality-inversion-in-automated-synthesis.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/expansions/legibility-debt-as-a-supervision-failure-mode.md` — knowledge/expansions/legibility-debt-as-a-supervision-failure-mode.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/expansions/connections/agent-health-and-daily-routine-automation-interdependence.md` — knowledge/expansions/connections/agent-health-and-daily-routine-automation-interdependence.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/expansions/connections/automation-reliability-and-daily-note-generation-dependency.md` — knowledge/expansions/connections/automation-reliability-and-daily-note-generation-dependency.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/expansions/connections/agent-accountability-and-system-constraints.md` — knowledge/expansions/connections/agent-accountability-and-system-constraints.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/knowledge/expansions/connections/accountability-gap-and-automation-routines.md` — knowledge/expansions/connections/accountability-gap-and-automation-routines.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-12.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-12.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-02.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-02.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-16.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-16.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-06.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-06.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-17.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-17.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-07.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-07.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-13.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-13.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-03.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-03.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-18.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-18.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-08.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-08.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-19.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-19.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-09.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-09.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-08-31.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-08-31.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-20.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-20.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-14.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-14.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-04.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-04.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-10.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-10.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-11.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-11.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-01.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-01.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-15.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-15.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/02_Areas/Agent-Fleet/daily-fleet-status-2026-09-05.md` — 02_Areas/Agent-Fleet/daily-fleet-status-2026-09-05.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-04-x-comic-one-liner-specimens.md` — 20_projects/research/2026-09-04-x-comic-one-liner-specimens.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-09-torres-husain-evals-in-discovery-findings.md` — 20_projects/research/2026-09-09-torres-husain-evals-in-discovery-findings.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-01-ai-creative-tools-licensing-confusion-pm-idea-ledger.md` — 20_projects/research/2026-09-01-ai-creative-tools-licensing-confusion-pm-idea-ledger.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-09-productcraft-bench-composition-findings.md` — 20_projects/research/2026-09-09-productcraft-bench-composition-findings.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-10-tier1-edition-audio-audit.md` — 20_projects/research/2026-09-10-tier1-edition-audio-audit.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-31-content-machine-rules-off-research.md` — 20_projects/research/2026-08-31-content-machine-rules-off-research.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-09-productcraft-research-cross-studio-handoff-prior-art.md` — 20_projects/research/2026-09-09-productcraft-research-cross-studio-handoff-prior-art.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-09-productcraft-research-drm-purchase-sheet.md` — 20_projects/research/2026-09-09-productcraft-research-drm-purchase-sheet.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-04-x-platform-mechanics.md` — 20_projects/research/2026-09-04-x-platform-mechanics.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-11-husain-evals-method-for-seat-pipelines.md` — 20_projects/research/2026-09-11-husain-evals-method-for-seat-pipelines.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-04-x-ai-experimenter-accounts.md` — 20_projects/research/2026-09-04-x-ai-experimenter-accounts.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-01-correcting-wrong-ai-assistant-information-pm-idea-ledger.md` — 20_projects/research/2026-09-01-correcting-wrong-ai-assistant-information-pm-idea-ledger.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-09-productcraft-book-to-seat-findings.md` — 20_projects/research/2026-09-09-productcraft-book-to-seat-findings.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-29-what-does-the-scholarly-and-serious-empirical-literature-say.md` — 20_projects/research/2026-08-29-what-does-the-scholarly-and-serious-empirical-literature-say.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-29-agentic-rails-leading-indicators-tracker.md` — 20_projects/research/2026-08-29-agentic-rails-leading-indicators-tracker.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-01-ai-work-licensing-risk-clients-pm-idea-ledger.md` — 20_projects/research/2026-09-01-ai-work-licensing-risk-clients-pm-idea-ledger.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-09-productcraft-plugin-routing-findings.md` — 20_projects/research/2026-09-09-productcraft-plugin-routing-findings.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-29-agent-web-observability-pm-idea-ledger.md` — 20_projects/research/2026-08-29-agent-web-observability-pm-idea-ledger.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-30-seam-recon-last30days-falsification.md` — 20_projects/research/2026-08-30-seam-recon-last30days-falsification.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-10-tier1-books-1-7-prices-audio.md` — 20_projects/research/2026-09-10-tier1-books-1-7-prices-audio.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-01-claim-accuracy-presale-pilot.md` — 20_projects/research/2026-09-01-claim-accuracy-presale-pilot.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-09-productcraft-research-local-trace-tooling.md` — 20_projects/research/2026-09-09-productcraft-research-local-trace-tooling.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-29-agentic-rails-odlyzko-check.md` — 20_projects/research/2026-08-29-agentic-rails-odlyzko-check.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-01-product-fitment-compatibility-mistakes-pm-idea-ledger.md` — 20_projects/research/2026-09-01-product-fitment-compatibility-mistakes-pm-idea-ledger.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-29-what-does-the-scholarly-literature-on-audience-measurement-a.md` — 20_projects/research/2026-08-29-what-does-the-scholarly-literature-on-audience-measurement-a.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-10-tier1-books-8-14-prices-audio.md` — 20_projects/research/2026-09-10-tier1-books-8-14-prices-audio.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-29-tech-revolution-patterns-council-premortem.md` — 20_projects/research/2026-08-29-tech-revolution-patterns-council-premortem.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-30-sept-1-sitting-inputs-indicator-read.md` — 20_projects/research/2026-08-30-sept-1-sitting-inputs-indicator-read.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-09-11-eval-viewer-design-prior-art.md` — 20_projects/research/2026-09-11-eval-viewer-design-prior-art.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/session-record.md` — 20_projects/substack-studio/spread-run/session-record.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/PROMPT-agentic.md` — 20_projects/substack-studio/spread-run/PROMPT-agentic.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/PROMPT.md` — 20_projects/substack-studio/spread-run/PROMPT.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/PROMPT-agentic-stripped.md` — 20_projects/substack-studio/spread-run/PROMPT-agentic-stripped.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/WINNER-for-rewrite.md` — 20_projects/substack-studio/spread-run/WINNER-for-rewrite.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/sean-final.md` — 20_projects/substack-studio/spread-run/sean-final.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/PROMPT-agentic-full.md` — 20_projects/substack-studio/spread-run/PROMPT-agentic-full.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/rules-off-experiment/session-record.md` — 20_projects/substack-studio/rules-off-experiment/session-record.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/rules-off-experiment/arm-a-draft.md` — 20_projects/substack-studio/rules-off-experiment/arm-a-draft.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/rules-off-experiment/arm-b-publish-ready.md` — 20_projects/substack-studio/rules-off-experiment/arm-b-publish-ready.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/rules-off-experiment/arm-b-draft.md` — 20_projects/substack-studio/rules-off-experiment/arm-b-draft.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/rules-off-experiment/arm-b-sean-final.md` — 20_projects/substack-studio/rules-off-experiment/arm-b-sean-final.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/what-are-these-guys-doing/draft.md` — 20_projects/substack-studio/what-are-these-guys-doing/draft.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/what-are-these-guys-doing/final.md` — 20_projects/substack-studio/what-are-these-guys-doing/final.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/what-are-these-guys-doing/records.md` — 20_projects/substack-studio/what-are-these-guys-doing/records.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/author-modes-deleted/final.md` — 20_projects/substack-studio/author-modes-deleted/final.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/drafts/a03-gpt55-codex.md` — 20_projects/substack-studio/spread-run/drafts/a03-gpt55-codex.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/drafts/a04-gpt55-api.md` — 20_projects/substack-studio/spread-run/drafts/a04-gpt55-api.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/drafts/a10-mistral-lg.md` — 20_projects/substack-studio/spread-run/drafts/a10-mistral-lg.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/drafts/a01-opus5-cc.md` — 20_projects/substack-studio/spread-run/drafts/a01-opus5-cc.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/drafts/a12-qwen36-local.md` — 20_projects/substack-studio/spread-run/drafts/a12-qwen36-local.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/drafts/a09-deepseek-v4.md` — 20_projects/substack-studio/spread-run/drafts/a09-deepseek-v4.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/drafts/a07-kimi-k3.md` — 20_projects/substack-studio/spread-run/drafts/a07-kimi-k3.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/drafts/a06-grok46.md` — 20_projects/substack-studio/spread-run/drafts/a06-grok46.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/drafts/a02-opus5-cc-twin.md` — 20_projects/substack-studio/spread-run/drafts/a02-opus5-cc-twin.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/drafts/a11-opus5-cc-stripped.md` — 20_projects/substack-studio/spread-run/drafts/a11-opus5-cc-stripped.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/substack-studio/spread-run/drafts/a05-gemini31pro.md` — 20_projects/substack-studio/spread-run/drafts/a05-gemini31pro.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-29-tech-revolution-patterns/chatgpt-dr-agent-spend-economics.md` — 20_projects/research/2026-08-29-tech-revolution-patterns/chatgpt-dr-agent-spend-economics.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-29-tech-revolution-patterns/build-in-public-candidate-odlyzko-check.md` — 20_projects/research/2026-08-29-tech-revolution-patterns/build-in-public-candidate-odlyzko-check.md
...
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-29-agentic-rails-odlyzko-check/demand-side.md` — 20_projects/research/2026-08-29-agentic-rails-odlyzko-check/demand-side.md
- **orphan** (T1): `/Users/seanwinslow/Code-Brain/code-brain/vault/20_projects/research/2026-08-29-agentic-rails-odlyzko-check/supply-side.md` — 20_projects/research/2026-08-29-agentic-rails-odlyzko-check/supply-side.md
