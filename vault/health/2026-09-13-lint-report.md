# Knowledge Lint Report — 2026-09-13

_1637 issues found (1387 structural, 250 semantic)._

_Tier-2 LLM scan: deferred (host unreachable)._

_314 finding(s) withheld from this tracked report (SOUL-derived, or about a file in a gitignored subtree). They remain counted below; full detail is in `/Users/seanwinslow/Code-Brain/code-brain/vault/health/private/2026-09-13-private-findings.md` (local-only, gitignored)._
