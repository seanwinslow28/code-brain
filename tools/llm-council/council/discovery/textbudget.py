...
"""Shared query-length clamp so a long topic/segment can't 422 a search provider.
...
Stage-5 backfill (observed 2026-06-28). This is the one place the ceilings and the trim live;
backfill + the reviews/github collectors all clamp through `clamp_words_chars`.
"""
