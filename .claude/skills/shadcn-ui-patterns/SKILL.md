...
description: "shadcn/ui component library patterns for accessible React UIs. Covers installation, Radix UI primitives, CSS variable theming (light/dark), React Hook Form + Zod validation, and 11 component patterns: Button, Input, Form, Card, Dialog, Select, Sheet, Menubar, Table, Toast, and Charts (Recharts). Includes Next.js App Router integration, customization via CVA variants, and common combinations (login forms, contact pages, dashboards). Use when building with shadcn/ui, setting up theming, creating forms with validation, or implementing accessible component patterns."
---
