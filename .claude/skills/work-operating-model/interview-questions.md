...
5. How does this domain's work flow split across your active email accounts? (Note: the prior work email was archived 2026-05 at the end of the prior role; default is `sean.winslow28@gmail.com`. Track recruiter / interview emails separately or via Gmail labels if needed.)
