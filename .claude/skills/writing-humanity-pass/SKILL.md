...
The breath-rhythm moves survive without it: **Breath-Mark Rhythm**, **Jewel Center**, **Sensory Cascade**, **Then/Now Narrator** and **Anaphoric Stack** all stay. Commas and periods carry the rhythm the dash used to. The only retired mechanic is "em dashes as breath marks." The authoritative protected-move list is [`references/voice-safe-exceptions.md`](references/voice-safe-exceptions.md) — this line summarises it and must not drift from it. *(Corrected 2026-09-02, [#224](https://github.com/seanwinslow28/code-brain/issues/224): this sentence named an author mode and protected **polysyndeton**, which the 2026-08-24 attestation deleted for zero corpus instances, while omitting **Anaphoric Stack**, a real attested move — so the scrub could cut the move Sean uses while shielding one he does not. [#176](https://github.com/seanwinslow28/code-brain/issues/176) filed that follow-up; the fix landed in the reference file and was orphaned here.)*
