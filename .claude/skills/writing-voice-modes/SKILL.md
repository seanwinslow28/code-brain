...
For full author technique profiles, sentence-level mechanics, and source analysis, see:
`vault/40_knowledge/references/ref-voice-mechanics-research.md`

Read this reference when doing deep craft work, writing exercises, or calibrating a new mode variation. Not needed for standard voice application.
