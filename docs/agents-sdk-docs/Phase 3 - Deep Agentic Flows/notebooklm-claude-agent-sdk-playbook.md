...
**My situation:**
- Career-switched into PM; managing a deliberate budget with aggressive cost discipline
- Saving toward multi-year financial goals
- Consistent early-morning training and health routine
...
- Flag cost implications — Sean runs a deliberate budget and needs to be smart about API spend. Always mention estimated per-run costs when suggesting new agents
