...
schedule-recommendations Protect / Automate / Decline lists for all three
domains.

IMPORTANT: Only the 6 currently-active agents in ACTIVE_AGENTS run.
...
def build_schedule_recs_context(config: Config | None) -> str:
    """Concatenate schedule-recommendations bodies for all three domains.
...
Use the schedule-recommendations context for the three domains as the
...
--- BEGIN SCHEDULE-RECOMMENDATIONS CONTEXT (3 domains) ---
...
def render_domain_aware_section(parsed: dict[str, list[str]] | None) -> str:
    ...
    return (
        ...
        "for the-block, creative-studio, and life-systems._\n\n"
