...
created: 2026-05-12
ai-context: "Comprehension artifact for the Phase D typed-edge layer in the Superuser Pack knowledge loop. 4-question template per Nate B Jones / ADR convention."
related:
  - "[[concept_edges.py]]"
  - "[[vault_indexer.py]]"
