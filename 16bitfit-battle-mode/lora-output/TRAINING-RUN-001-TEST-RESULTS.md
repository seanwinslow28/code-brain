...
**Date:** 2026-04-08 **Machine:** Alienware RTX 5080 (16GB GDDR7) **Companion doc:** [TRAINING-RUN-001.md](http://TRAINING-RUN-001.md) (training configuration and metrics)
...
| Attention | SDPA (no xformers — RTX 5080 sm\_120 constraint) |
...
16bitfit\_style, pixel art fighter, solo, single character, \[POSE DESCRIPTION\],
...
p{prompt\_index}\_{pose}\_{checkpoint}\_{strength}\_seed{seed}.png
...
C:\\Users\\seanw\\Documents\\Code-Brain\\lora-output\\16bitfit-style\\comfyui-test\\run\_lora\_test.py
